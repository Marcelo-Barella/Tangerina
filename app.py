...
resolve_voice_channel = partial(_resolve_voice_channel, bot=bot, music_bot=music_bot)
...
async def speak_tts(guild_id: int, channel_id: int, text: str, provider: Optional[str] = None) -> Dict[str, Any]:
    return await speak_tts_unified(
        ...
        music_bot, resolve_voice_channel, music_bot.ytdl, YTDLSource
    )

music_bot.speak_tts_func = partial(speak_tts, provider='piper')
